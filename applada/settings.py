"""
Django settings for applada project.
...
SECRET_KEY = 'j)!otp@9ke2@m6g8rptf8vyn3-u$3d%gf9pb32xovx5@tz(0sz'
...
MIDDLEWARE = [
    ...
    'api_v1.middleware.NotFoundMiddleware'
]
...
NOSE_ARGS = ['--with-spec', '--spec-color', '--rednose']
